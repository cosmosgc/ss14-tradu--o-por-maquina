...
class Project:
    def __init__(self):
        ...
        self.pt_locale_dir_path = os.path.join(self.locales_dir_path, 'pt-BR')
        ...
        self.en_locale_prototypes_dir_path = os.path.join(self.en_locale_dir_path, 'ss14-br', 'prototypes')
        self.pt_locale_prototypes_dir_path = os.path.join(self.pt_locale_dir_path, 'ss14-br', 'prototypes')
